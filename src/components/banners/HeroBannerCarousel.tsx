...
const slides = [
  {
    ...
    body: "Nature Nook manufactures and distributes 150+ premium herbal extracts for Ayurvedic medicines, cosmetics, and nutraceuticals — straight from Indore.",
  ...
  },
  {
    ...
    body: "Sourced from premium Indian roots, our Ashwagandha extract delivers consistent adaptogenic benefits. Batch-tested COA available.",
    cta1: { label: "View Extract", href: "/product/1" },
    cta2: { label: "Request Sample", href: "/vendor" },
    imageSrc: "/hero-ashwagandha.png",
    imageMobile: "/hero-ashwagandha-m.png",
    imageAlt: "Ashwagandha extract",
  },
  {
    ...
    body: "Join 200+ brands sourcing premium herbal extracts. Competitive bulk pricing, GMP certified facility, and COA on every order.",
